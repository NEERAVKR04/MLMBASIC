            ...
            <form action="requestPayment.php" method="POST">
                <div class="login_details">
                    ...
                    <?php if(isset($errors['activation_status'])){?> <br/><label style="color: red;font-size: 1.5rem;margin-left: auto;margin-right: auto;"><?php echo $errors['activation_status'] ?></label>
                        <?php } ?>
                    <?php if(isset($errors['upi'])){?> <br/><label style="color: red;font-size: 1.5rem;margin-left: auto;margin-right: auto;"><?php echo $errors['upi'] ?></label>
                        <?php } ?>
                    <?php if(isset($errors['paytm'])){?> <br/><label style="color: red;font-size: 1.5rem;margin-left: auto;margin-right: auto;"><?php echo $errors['paytm'] ?></label>
                        <?php } ?>
                    <?php if(isset($errors['paypal'])){?> <br/><label style="color: red;font-size: 1.5rem;margin-left: auto;margin-right: auto;"><?php echo $errors['paypal'] ?></label>
                        <?php } ?>
                    <?php if(isset($errors['pending'])){?> <br/><label style="color: red;font-size: 1.5rem;margin-left: auto;margin-right: auto;"><?php echo $errors['pending'] ?></label>
                        <?php } ?>
