...
<div class="square"><b style="color: #000;"><br/>Total Balance<?php echo "<br>"."<br>"."Rs ".$credit."/-"; ?></b></div>
<div class="square"><b style="color: #000;"><br/>Total Withdrawal<?php echo "<br>"."<br>"."Rs ".$withdrawal."/-"; ?></b></div>
<div class="square"><b style="color: #000;"><br/>Lifetime Earning<?php echo "<br>"."<br>"."Rs ".$lifetime_earning."/-"; ?></b></div>
<br/>
